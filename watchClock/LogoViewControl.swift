...
class LogoViewControl : UITableViewController {
...
//        print(indexPath.row)
        ...
        NotificationCenter.default.post(name: NSNotification.Name.init("newlogo"), object: indexPath.row)
